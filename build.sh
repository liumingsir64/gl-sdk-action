...
axt1800_sdk_get()
{
	...
	echo src-git passwall_packages https://ghproxy.com/https://github.com/xiaorouji/openwrt-passwall-packages.git;main >>${WORKDIR}/openwrt-sdk/feeds.conf.default"
        echo src-git passwall2 https://ghproxy.com/https://github.com/xiaorouji/openwrt-passwall2.git;main >>${WORKDIR}/openwrt-sdk/feeds.conf.default"
